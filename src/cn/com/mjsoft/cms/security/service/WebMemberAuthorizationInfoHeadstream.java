...
/**
 * (会员)针对web的权限信息源。web的请求对象将会在这里处理，解析出信息后会从数据源获取相关权限资源
 * 
 * @author $Author: mjsoft
 * 
 * 
 */
public class WebMemberAuthorizationInfoHeadstream implements AuthorizationInfoHeadstream
{
    ...
    public Set getAuthorizationInfoBatch( String key )
    {
        ...
        Set securityResourceRoleIdSet = securityResourceService
            .retrieveMemberTargetResourceRelateRoleIdSetByKey( key );
