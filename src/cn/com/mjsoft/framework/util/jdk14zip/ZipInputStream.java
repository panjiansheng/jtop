...
public class ZipInputStream extends InflaterInputStream implements ZipConstants
{
     ...
     */
    private ZipEntry readLOC( String charset ) throws IOException
    {
        try
        {
        ...
        ZipEntry e = createZipEntry( getUTF8String( b, 0, len, charset ) );
