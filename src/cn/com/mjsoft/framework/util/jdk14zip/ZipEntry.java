...
public class ZipEntry implements ZipConstants, Cloneable
{
     ...
     * @exception IllegalArgumentException if the specified size is less than 0
     *                or greater than 0xFFFFFFFF bytes
     * @see #getSize()
     */
     ...
     * @exception IllegalArgumentException if the specified CRC-32 value is less
     *                than 0 or greater than 0xFFFFFFFF
     * @see #setCrc(long)
     */
     ...
     * @exception IllegalArgumentException if the length of the specified extra
     *                field data is greater than 0xFFFF bytes
     * @see #getExtra()
     */
