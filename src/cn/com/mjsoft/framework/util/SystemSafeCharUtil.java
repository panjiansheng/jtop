...
{
    private static Logger log = Logger.getLogger( SystemSafeCharUtil.class );
    ...
    static
    {
        SQL_D_STR_A = StringUtil.split( SQL_D_STR, "\\|" );
    }
    ...
    public static String resumeHTML( String input )
    {
        ...
        input = StringUtil.replaceString( input, "&lt;", "<", false, false );
    ...
    {
        if( StringUtil.isStringNotNull( keyword ) )
        {
            // String[] fbsArr = { "\\", "$", "(", ")", "*", "+", ".", "[", "]",
            // "?", "^", "{", "}", "|" };
    ...
    public static String encodeDangerChar( String input )
    {
        ...
        if( StringUtil.isStringNull( input ) || !haveDangerChar( input ) )
        {
            return input;
        }
        ...
        target = StringUtil.replaceString( target, "'", "**!1**", false, false );
        target = StringUtil.replaceString( target, "(", "**!2**", false, false );
        target = StringUtil.replaceString( target, ")", "**!3**", false, false );
        target = StringUtil.replaceString( target, "..", "**!4**", false, false );

        // target = StringUtil.replaceString( target, "\'","**!5**", false,
        // false );
        target = StringUtil.replaceString( target, "\"", "**!6**", false, false );
        // target = StringUtil.replaceString( target, "\\\"","**!7**", false,
        // false );
        target = StringUtil.replaceString( target, "<", "**!8**", false, false );

        target = StringUtil.replaceString( target, ">", "**!9**", false, false );
        target = StringUtil.replaceString( target, "|", "**!10**", false, false );
        target = StringUtil.replaceString( target, "\\", "**!11**", false, false );
        target = StringUtil.replaceString( target, "+", "**!12**", false, false );

        // target = StringUtil.replaceString( target,";", "**!13**", false,
        // false );
        target = StringUtil.replaceString( target, "@", "**!14**", false, false );
        target = StringUtil.replaceString( target, "$", "**!15**", false, false );
        target = StringUtil.replaceString( target, ":", "**!16**", false, false );
        // target = StringUtil.replaceString( target, "/","**!17**", false,
        // false );
        target = StringUtil.replaceString( target, " a", "**!18**", false, false );
        target = StringUtil.replaceString( target, " A", "**!19**", false, false );
        target = StringUtil.replaceString( target, "/**/", "**!20**", false, false );
    ...
    public static String decodeDangerChar( String input )
    {
        ...
        // target = StringUtil.replaceString( target, "**!17**", "/", false,
        // false );
        target = StringUtil.replaceString( target, "**!18**", " a", false, false );
        target = StringUtil.replaceString( target, "**!19**", " A", false, false );
        target = StringUtil.replaceString( target, "**!20**", "/**/", false, false );
