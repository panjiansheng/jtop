					...
					<div>
						...
						<div class="bs-example">
							<div class="tie-titlebar">
								<span style="left:120px; top:30px; font-size:18px; font-weight:bold; padding:10px 15px; color:#06c">找回密码邮件</span>
								<ins>
														...
														<table width="100%" border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td>
																	...
																	<input name="email" id="email" type="text" style="width:395px" class="form-control" />
																<td>
