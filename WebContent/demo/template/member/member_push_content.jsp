						...
						<form id="memForm" name="memForm" method="post">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td>
										<input name="title" id="title" type="text" class="from-input" />
									</td>
								</tr>
								<tr>
									<td align="right">
								...
								<tr>
									...
									<td>
										<input name="keywords" id="keywords" type="text" class="from-input" />
									</td>
								</tr>
								<tr>
									<td align="right">
									...
									<td>
										<input name="author" id="author" type="text" class="from-input" />
									</td>
								</tr>
								<tr>
									<td align="right">
								...
								<tr>
									...
									<td>
										<input name="summary" id="summary" type="text" class="from-input" />
								...
								<tr>
									...
									<td colspan="2">
											...
											<textarea id="mh_wz" name="mh_wz" style="height:290px"  ></textarea>
								...
								<tr>
									...
									<td>
										<input type="button" name="button" id="button" value="存稿" class="btn btn2 fl btn-primary" onclick="javascript:addContent('draft');" />

										<cms:WorkflowActionUIHelp classId="${param.classId}">
										&nbsp;&nbsp;&nbsp;&nbsp;
										<button type="button" class="btn btn2  btn-primary" onclick="javascript:addContent('','${Action.actionId}','${Action.fromStepId}','${Action.toStepId}');">
