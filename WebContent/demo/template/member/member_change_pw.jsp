						...
						<div>
							...
							<div class="bs-example">
															...
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td>
																		...
																		<input name="oldPw" id="oldPw" type="text" style="width:395px" class="form-control" />
																...
																<tr>
																	<td>
																		<cms:Class id="${param.classId}">
																			<input name="newPw" id="newPw"  type="text" style="width:395px" class="form-control" >
															...
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td>
																		...
																		<input name="checkNewPw" id="checkNewPw" type="text" style="width:395px" class="form-control" />
								...
								<div class="highlight">
									...
									<span class="fr"><button type="button" class="btn btn-primary" onclick="javascript:changePW();">
											确认
										</button>   </span>
								</div>
							</div>
			    ...
			    $.ajax({
			        ...
			        {        
			            ...
			            if('1' == msg)
			            {
							...
							window.location.href = '${SiteBase}member/member_change_pw.jsp';
			            }
			            else if('-1' == msg)
			            {
							alert('请输入正确的验证码!');
