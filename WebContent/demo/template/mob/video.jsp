...
<html>
	...
	<script type="text/javascript" src="${ResBase}js/player/images/swfobject.js"></script>
	<script type="text/javascript" src="${ResBase}js/commonUtil_src.js"></script>
 	 
	<script type="text/javascript" src="${ResBase}js/player/cpMobile/js/action.js"></script>
	...
	<body>
		...
		<div class="mui-content">			
			...
			<div class="mui-content-padding article-content-text mui-bg-white">
				...
				var vWidth     = "100%";
				var vHeight    = 249;
				var vFile      = "${ResBase}js/player/cpMobile/CuSunV2set.xml";
				var vPlayer    = "${ResBase}js/player/cpMobile/player.swf?v=2.5";
				
				<cms:if test="${empty Info.mh_sp_fileMediaC}">
						
						var vPic       = "${ResBase}js/player/cpMobile/images/start.jpg";
				...
				var vCssurl    = "${ResBase}js/player/cpMobile/images/mini.css";
				...
				<script class="CuPlayerVideo" data-mce-role="CuPlayerVideo" type="text/javascript" src="${ResBase}js/player/cpMobile/js/CuSunX1.min.js"></script>	 
