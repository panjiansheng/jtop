...
<html>
	...
	<body>
		...
		<div class="mui-content">			
			...
			<form id= "uploadForm">  
      <p >指定文件名： <input type="text" name="filename" value= "" accept="image/png,image/gif"/></p>  
      <p >上传文件： <input type="file" name="file" accept="image/png,image/gif,image/jpg,image/jpeg,"/></p>  
...
function doUpload() {  
     ...
     $.ajax({  
          url: '${SiteBase}content/multiUpload.do' ,  
          type: 'POST',  
          data: formData,  
          async: false,  
          cache: false,  
