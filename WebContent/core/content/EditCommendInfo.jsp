											...
											<form id="commForm" name="commForm" method="post">
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
													<tr>
														...
														<td class="td-input">
															<input id="title" name="title" type="text" value="${CommInfo.title}" maxLength="80" style="width: 400px;" class="form-input-title titlerule" />
													...
													<tr>
														...
														<td class="td-input">
															<input id="url" name="url" type="text" class="form-input" maxlength="600" style="width: 400px;"  value="${CommInfo.urlOrgVal}"/>
																						...
																						<table border="0" cellpadding="0" cellspacing="0" height="65" class="form-table-big">
																							<tr>
																								<td>
																									...
																									<input type="button" value="裁剪" onclick="javascript:disposeImage('img','${CommendType.imageWidth}','${CommendType.imageHeight}',false,'-1');" class="btn-1" />
													...
													<tr>
														...
														<td class="td-input">
															<textarea id="summary" name="summary" class="form-textarea" style="width:405px; height:70px;">${CommInfo.summary}</textarea>
													</tr>
...
<cms:Content id="${CommInfo.contentId}">
	...
	var contentClassId = '${Info.classId}';
	
	if('' != contentClassId && '-1' != contentClassId)
	{
		document.getElementById('classId').value=contentClassId;
	}
...
function submitCommForm()
{
   ...
   commForm.action="../../content/editSingleCommendInfo.do";
   commForm.submit();
}

function sortRow(flag,infoId)
{
	var url = "../../content/sortCommendInfo.do?typeId=${param.typeId}&type=row&infoId="+infoId+"&flag="+flag+"&<cms:Token mode='param'/>";
