	...
	<head>
		...
		base = '<cms:Domain/>';
         ...
         var swfu;
			...
			file_size_limit : "${CurrSite.fileMaxC} MB", 
									...
									<li>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
											...
											<tr id="serverTr">
												...
												<td class="td-input">
													<textarea readonly id="fileInfo" name="fileInfo" style="height:80px;width:270px" class="form-textarea"></textarea>
											...
											<tr>
												...
												<td class="td-input">
													<input type="text" style="width:272px" id="titleName" name="titleName" class="form-input"></input>
												</td>
											</tr>
 	...
 	$.ajax({
        ...
        {        
        	...
        	else
        	{
				...
				var kbSize =  accDiv(jsonObj.obj_0.resSize,1024);
				var size = 0;
				var testKb = Math.floor(kbSize);
				if(testKb > 1024)
				{
				   size = accDiv(jsonObj.obj_0.resSize,1024 * 1024).toFixed(2)+" MB";	
				}
				else
				{
				...
				{
					//此值用于页面显示
				    api.get(apiId).document.getElementById(fieldSign+'_sys_jtopcms_file_info').value=jsonObj.obj_0.resName+' ('+size+')';
			 
			        //此值由cms最后处理
			        api.get(apiId).document.getElementById(fieldSign).value= jsonObj.obj_0.resId;
				...
				else
				{
				    ...
				    //此值用于页面显示
				    W.document.getElementById(fieldSign+'_sys_jtopcms_file_info').value=jsonObj.obj_0.resName+' ('+size+')';
