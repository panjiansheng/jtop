						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									...
									<a name="btnwithicosysflag" href="javascript:chooseTag();"  class="btnwithico"><img src="../../style/icons/tick.png" width="16" height="16" /><b>确定&nbsp;</b> </a>
...
function chooseTag()
{
		...
		var url = "<cms:BasePath/>content/addMutiTag.do?ids="+ids+"&cIds=${param.cIds}"+"&<cms:Token mode='param'/>";
...
function clearTag()
{
	W.document.getElementById('tagKeyVal').value = '';
	W.document.getElementById('tagKey').value = '';	
