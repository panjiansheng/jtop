...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<cms:QueryData service="cn.com.mjsoft.cms.common.service.CommonSystemService" method="getCmsSystemRuntimeInitCacheTag" objName="CmsCfg" >
		...
		function initialize() {
		//---------------------------------------------基础示例---------------------------------------------
		map = new BMap.Map("allmap",{minZoom:8,maxZoom:25});            // 创建Map实例
		...
		if(currentArea == '')
		{
			...
			map.centerAndZoom('${CmsCfg.baiduMapDefCity}', 13);
			
		}
		else
		{
			map.centerAndZoom(currentArea, 13); 
		}                    // 初始化地图,设置中心点坐标和地图级别。
		...
		var txtMenuItem = [  //右键菜单项目
			...
			
			{
				...
				callback:function(p){
					...
					var mt = document.getElementById('mapT').value;
					
					var mc = document.getElementById('mapC').value;
					...
					if('' != mt || '' != mc)
					{
						...
						marker.openInfoWindow(infoWindow,p); //开启信息窗口
...
function changeArea()
{
	...
	window.location = 'BaiduMap.jsp?area='+encodeURIComponent(encodeURIComponent(endArea))+'&editorId=${param.editorId}&dialogMode=${param.dialogMode}'
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
					...
					<input onclick="javascript:changeArea();" value="切换" class="btn-1" type="button" style="vertical-align:top;" />
					&nbsp;&nbsp;
					图宽:&nbsp;<input id="mapW" class="form-input" type="text" size="3" value="500"/>
					&nbsp;&nbsp;
					图高:&nbsp;<input id="mapH" class="form-input" type="text" size="3" value="300"/>
					<cms:if test="${empty param.area}">
					&nbsp;&nbsp;当前地点：<input  class="form-input" type="text" size="18" readonly value="<cms:DecodeParam  enc="utf-8" str="${CmsCfg.baiduMapDefCity}" />"/>
					</cms:if>
					<cms:else>
					&nbsp;&nbsp;当前地点：<input  class="form-input" type="text" size="22" readonly value="<cms:DecodeParam  enc="utf-8" str="${param.area}" />"/>
					</cms:else>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					图片模式&nbsp;:&nbsp;<input id="imgMode" class="form-checkbox" type="checkbox"  value="1"/>
			...
			<td>
					&nbsp;&nbsp;
					信息标题:&nbsp;<input id="mapT" class="form-input" type="text" style="width:300px" value=""/>
					&nbsp;&nbsp;&nbsp;
					内容:&nbsp;<input id="mapC" class="form-input" type="text" style="width:300px" value=""/>
					&nbsp;(请右键添加标注)
					<div style="height:7px"></div>
			...
			<tr>
				<td>
					<center>
						<div id="allmap" style="width: 855px; height: 450px"></div>
					</center>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" >
						<tr class="btnbg100">
							<div style="float:right">
								<a href="javascript:showMap();"  class="btnwithico"><img src="../../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
	...
	if('true' == '${param.dialogMode}')
	{
	 ...
	 if('${param.editorId}' != '')
	 {
		   ...
		   var mc = document.getElementById('mapC').value;
	 	   ...
	 	   <cms:CurrentSite>
	 	   var siteUrl = '<cms:BasePath/>'
	 	   </cms:CurrentSite>
	 	   
	 	   var url = siteUrl+'core/content/editor/ShowBaiduMap.jsp?w='+mapW+'&h='+mapH+'&px='+map.getCenter().lng +'&py='+map.getCenter().lat+'&zoom='+map.getZoom()+'&mt='+encodeURIComponent(encodeURIComponent(mt))+'&mc='+encodeURIComponent(encodeURIComponent(mc))+'&tPx='+tPx+'&tPy='+tPy
	 	  
	 	   var staticM = '';
	 	   if ('' != tPx && '' != tPy)
	 	   {
	 	   		staticM = '&markers='+tPx+','+tPy;
	 	   }
	 	   
	 	  
	 	   var staticUrl = 'http://api.map.baidu.com/staticimage?center='+map.getCenter().lng+','+map.getCenter().lat+'&zoom='+map.getZoom()+'&width='+(parseInt(mapW)+5)+'&height='+mapH+staticM ;
	 	   
	 	   //if(oEditor.EditMode == wd.FCK_EDITMODE_WYSIWYG)
		   //{
		   		
		   		//if(document.getElementById('imgMode').checked == true)
		   		//{
		   			//oEditor.InsertHtml(  '<img style="margin:20px" width="' + mapW + '" height="' + mapH + '" src="'+staticUrl+'" /><br/>');
		   		//}
				//else
				//{
					//oEditor.InsertHtml('<iframe src="' + url + '" frameborder="0" style="width:' + mapW + 'px;height:' + mapH + 'px;"></iframe><br/>');
				//}	
		   ...
		   //}
				...
				if(document.getElementById('imgMode').checked == true)
		   		{
		   			wd.ue.execCommand('insertHtml', '<img style="margin:20px" width="' + mapW + '" height="' + mapH + '" src="'+staticUrl+'" /><br/>');
		   		}
				else
				{
					wd.ue.execCommand('insertHtml', '<iframe src="' + url + '" frameborder="0" style="width:' + mapW + 'px;height:' + mapH + 'px;"></iframe><br/>');
				}	
