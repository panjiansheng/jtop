		...
		<form id="advertConfigForm" name="advertConfigForm" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
				<tr>
					...
					<td class="td-input">
						<input type="text" style="width:264px"  id="configName" name="configName" class="form-input"></input>
				...
				<tr>
					...
					<td class="td-input">
						<textarea id="configDesc" name="configDesc" style="height:70px;width:260px" class="form-textarea"></textarea>
					</td>
				</tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr class="btnbg100">
						<div style="float:right">
							<a name="btnwithicosysflag" href="javascript:submitAdvertConfigForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
{    
    ...
    form.action="<cms:BasePath/>trevda/createTrevdaConfig.do";
