			...
			<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						...
						当前位置：
						<a href="#">数据分析</a> &raquo; <a href="#">访问者客户端</a> &raquo; <a href="#">分辨率</a>
					</td>
					<td align="right">
						...
						<tr>
							<td style="padding: 7px 10px;">
								...
								<a href="javascript:changeChart();" class="btnwithico"><img src="../style/icons/chart-up.png" width="16" height="16" /><b>重新统计&nbsp;</b> </a>
									&nbsp;	<span style="align:middle">(访问用户屏幕分辨率统计)		</span>
													            ...
													            function (ec) {  
																    ...
																    legend: {
																        ...
																        data:[
																           ...
																           <cms:QueryData objName="Ht" common="true" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteVisitScPvInfoTag" >
																			<cms:if test="${status.index < 10}">
																    ...
																    series : [
																        {
																            ...
																            data:[
																            	...
																            	<cms:QueryData objName="Hst" reObj="Ht">
															 						<cms:if test="${status.index < 10}">
																					<cms:if test="${!status.last}">
																				 		{value:${Hst.pvPer}, name:'${Hst.resVal}'},
								...
								<div class="DataGrid">
										...
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="datahead">
											 ...
											 <cms:QueryData objName="VisLog" common="true" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteVisitScPvInfoTag" >
