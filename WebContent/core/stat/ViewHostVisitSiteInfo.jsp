			...
			<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						...
						当前位置：
						<a href="#">数据分析</a> &raquo; <a href="#">综合报告</a> &raquo; <a href="#">站群分析</a>
					</td>
					<td align="right">
						...
						<tr>
							<td style="padding: 7px 10px;">
								...
								<a href="javascript:changeChart();" class="btnwithico"><img src="../style/icons/chart-up.png" width="16" height="16" /><b>重新统计&nbsp;</b> </a>
									&nbsp;	<span style="align:middle">(站群系统中所有站点的访问点击量百分比)		</span>
													           ...
													           [  
													            ...
													            function (ec) {  
																    ...
																    legend: {
																        ...
																        <cms:QueryData objName="Ht" common="true" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteHostVisitInfoTag" var="">
