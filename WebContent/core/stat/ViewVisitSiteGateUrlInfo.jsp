			...
			<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						...
						当前位置：
						<a href="#">数据分析</a> &raquo; <a href="#">点击数据排行</a> &raquo; <a href="#">入口排行</a>
					</td>
					<td align="right">
					...
					<table class="listtable" width="99.8%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td style="padding: 7px 10px;">
								<div class="fl">
									<span style="align:middle"> <a href="javascript:changeChart();" class="btnwithico"><img src="../style/icons/chart-up.png" width="16" height="16" /><b>重新统计&nbsp;</b> </a> &nbsp;(访问者访问入口URL次数统计) </span>
							...
							<td id="uid_td25" style="padding: 2px 6px;">
								<div class="DataGrid">
									...
									<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
										...
										<cms:QueryData objName="VisLog" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteVisitGateInfoTag">
