			...
			<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						...
						当前位置：
						<a href="#">数据分析</a> &raquo; <a href="#">访问者客户端</a> &raquo; <a href="#">使用语言</a>
					</td>
					<td align="right">
						...
						<tr>
							<td style="padding: 7px 10px;">
								...
								<a href="javascript:changeChart();" class="btnwithico"><img src="../style/icons/chart-up.png" width="16" height="16" /><b>重新统计&nbsp;</b> </a>
									&nbsp;	<span style="align:middle">(访问用户使用语言统计)		</span>
													            ...
													            function (ec) {  
																    ...
																    legend: {
																        ...
																        data:[
																          ...
																          <cms:QueryData objName="Ht" common="true" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteVisitLaPvInfoTag" >
																    ...
																    series : [
																        {
																            ...
																            data:[
																            	...
																            	<cms:QueryData objName="Hst" reObj="Ht">
																					...
																					<cms:if test="${!status.last}">
																				 		{value:${Hst.pvPer}, name:'${Hst.laName}'},
