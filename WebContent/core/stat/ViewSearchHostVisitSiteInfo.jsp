			...
			<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						...
						当前位置：
						<a href="#">数据分析</a> &raquo; <a href="#">访问源分析</a> &raquo; <a href="#">搜索引擎数据</a>
					</td>
					<td align="right">
						...
						<tr>
							<td style="padding: 7px 10px;">
								...
								<a href="javascript:changeChart();" class="btnwithico"><img src="../style/icons/chart-up.png" width="16" height="16" /><b>重新统计&nbsp;</b> </a>
									&nbsp;	<span style="align:middle">(来源于搜索引擎的站点百分比)		</span>
													            ...
													            function (ec) {  
																    ...
																    legend: {
																        ...
																        data:[
																         ...
																         <cms:QueryData objName="Ht" common="true" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteVisitSearchHostUvInfoTag" >
																    ...
																    series : [
																        {
																            ...
																            data:[
																            	...
																            	<cms:QueryData objName="Hst" reObj="Ht">
																					...
																					<cms:if test="${!status.last}">
																				 		{value:${Hst.uvPer}, name:'${Hst.searchName}'},
							...
							<td id="uid_td25" style="padding: 2px 6px;">
								<div class="DataGrid">
										...
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:QueryData objName="VisLog" common="true" service="cn.com.mjsoft.cms.stat.service.StatService" method="getSiteVisitSearchHostUvAllInfoTag" >
