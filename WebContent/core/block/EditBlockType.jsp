		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					...
					<cms:SystemBlockType typeId="${param.blockTypeId}">
					<form id="blockForm" name="blockForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td  class="td-input">
									<input id="blockTypeName" name="blockTypeName" type="text" class="form-input" style="width:294px;" value="${BlockType.blockTypeName}"/>
							...
							<tr>
								...
								<td width="80%" class="td-input">
									<input id="templateUrl" name="templateUrl" type="text" class="form-input" style="width:294px;" value="${BlockType.templateUrl}" />
						...
						<!-- hidden -->
						<input id="blockTypeId" name="blockTypeId" type="hidden" value="${param.blockTypeId}" />
...
function submitBlockForm()
{
   ...
   blockForm.action="<cms:BasePath/>block/editBlockType.do";
   blockForm.submit();
}
