				...
				<tr>
					<td align="left" valign="top">
						...
						<form id="secForm" name="secForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td width="80%" class="td-input">
										<input type="text" style="width:318px" id="typeName" name="typeName" class="form-input"></input>
								...
								<tr>
									...
									<td class="td-input">
										<input type="text" style="width:318px" id="accSymbol" name="accSymbol" class="form-input"></input>
										<span class="red">*</span><span class="ps"></span>
									</td>
								</tr>
								<tr>
									...
									<td class="td-input">
										<textarea id="accBehaviorClass" name="accBehaviorClass" style="width:318px; height:60px;" class="form-textarea"></textarea>
									</td>
								</tr>
								<tr>
									<td width="20%" class="input-title">
									...
									<td class="td-input">
										<textarea id="dtDesc" name="dtDesc" style="width:318px; height:70px;" class="form-textarea"></textarea>
									</td>
								</tr>
							...
							<!-- hidden -->
							<input type="hidden" id="isSys" name="isSys" value="0" />
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr class="btnbg100">
									<div style="float:right">
										<a name="btnwithicosysflag" href="javascript:submitSecForm();" class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitSecForm()
{
   ...
   secForm.action="<cms:BasePath/>security/addSecType.do";
   secForm.submit();
}
