							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								<tr>
									...
									<td width="80%" class="td-input">
										<input type="text" style="width:262px" id="roleName" name="roleName" class="form-input" value="${Role.roleName}"></input>
								...
								<tr>
									...
									<td class="td-input">
										<textarea id="roleDesc" name="roleDesc" style="width:260px; height:60px;" class="form-textarea">${Role.roleDesc}</textarea>
									</td>
								</tr>
...
function submitRoleForm()
{
   ...
   roleForm.action="<cms:BasePath/>security/editSystemRole.do";
   roleForm.submit();
}
