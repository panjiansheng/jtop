		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					<!--main start-->
					<div class="addtit">
						<img src="../style/icons/users.png" width="16" height="16" />角色
					</div>
					...
					<form id="roleForm" name="roleForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:262px" id="roleName" name="roleName" class="form-input" ></input>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="roleDesc" name="roleDesc" style="width:262px; height:70px;" class="form-textarea"></textarea>
								</td>
							</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" >
						<tr class="btnbg100">
							 <div style="float:right">
								<a name="btnwithicosysflag" href="javascript:submitRoleForm();" class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitRoleForm()
{
   ...
   roleForm.action="<cms:BasePath/>security/addSystemRole.do";
   roleForm.submit();
}
