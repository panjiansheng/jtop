						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td width="80%" class="td-input">
									<select name="parentResId" " id="parentResId" style="width:351px">
										<option value="-1">
											----------------------- 无(为顶级资源) ---------------------
										</option>
										<cms:DisplaySecurityResource />
									</select>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:347px" id="resourceName" name="resourceName" class="form-input"></input>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:347px" id="target" name="target" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:347px" id="sysFlag" name="sysFlag" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:130px" id="icon" name="icon" class="form-input" value="document.png" />
										
										<input onclick="javascript:openSelectIconDialog('oard');" value="选择" class="btn-1" type="button" />
...
initSelect('parentResId','${param.parent}');
...
function submitResourceForm()
{
	...
	//后台验证
	var url = "<cms:BasePath/>security/checkSecType.do?parentId="+$('#parentResId').val()+'&resType='+$('[name=resourceType]:checked').val();
   ...
   resourceForm.action="../../security/addSecurityResource.do";
   resourceForm.submit();
