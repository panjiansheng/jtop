				...
				<td align="left" valign="top">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
						...
						<tr >
							...
							<td class="td-input">
								<textarea readonly style="height:230px;width:520px" class="form-textarea" readonly>${Msg.msgContent}</textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="td-input">
								<textarea readonly id="replyContent" name="replyContent" style="height:230px;width:520px" class="form-textarea">${Msg.replyContent}</textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="td-input">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table-upload">
									<tr>
										<td width="42%">
											收件人: <cms:SystemUser id="${Msg.sender}">${SysUser.userName}</cms:SystemUser>
										</td>
										<td width="40%">
											回复时间:
											<cms:FormatDate date="${Msg.replyDT}" />
										</td>
