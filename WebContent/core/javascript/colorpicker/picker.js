	...
	var bigColorPicker = new function(){
		...
		this.init = function(){
			...
			$("#bigLayout").hover(function(){
				...
				//add:点击颜色离开才可生效,使用方法: 目标inputId->title  选择器Id->titleBg  hiddenId->titleBgVal
				var titleId = currentPicker.id.replaceAll('Bg','');
							
				var titleText = document.getElementById(titleId);
				titleText.style.color = $('#'+currentPicker.id+'Val').val();
