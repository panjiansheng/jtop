...
{	
	...
	else
	{
		W.$.dialog({ 
	        ...
	        min: false, 
	        resize: false,         
	        content: 'url:'+basePath+'core/content/editor/ImageUpload.jsp?classId='+classId+'&editorId='+editorId+'&isDialogMode=true'
		});
	}
	...
	if(e != null && e.tagName != null && 'IMG' == e.tagName )
	{
		...
		else
		{
			W.$.dialog({ 
		        ...
		        content: 'url:'+basePath+'/core/content/DisposeImage.jsp?editorId='+editorId+'&fieldSign='+fieldSign+'&mw='+mw+'&mh='+mh+'&fmw='+mw+'&fmh='+mh+'&orgResId='+resId+'&resId='+resId+'&ratio=false'+'&gm='+gm+'&order='+order+'&uid='+Math.random()+'&dialog=true&api=main_content'
...
function showDownloadDialog(editorId)
{
	...
	else
	{
		W.$.dialog({ 
	        ...
	        min: false, 
	        resize: false,         
	        content: 'url:'+basePath+'core/content/editor/Attachment.jsp?classId='+classId+'&editorId='+editorId+'&dialog=true&api=main_content'
		});
...
function showDisposeBaiduMapDialog(editorId)
{
	...
	else
	{
		W.$.dialog({ 
	        ...
	        min: false, 
	        resize: false,         
	        content: 'url:'+basePath+'core/content/editor/BaiduMap.jsp?editorId='+editorId+'&dialogMode=true'
		});
...
function showMediaDialog(editorId)
{
	...
	else
	{
		W.$.dialog({ 
	        ...
	        min: false, 
	        resize: false,         
	        content: 'url:'+basePath+'core/content/editor/MediaUpload.jsp?classId='+classId+'&editorId='+editorId+'&dialog=true&api=main_content'
		});
...
function showOfficeDialog(editorId)
{
	...
	else
	{
		W.$.dialog({ 
	        ...
	        min: false, 
	        resize: false,         
	        content: 'url:'+basePath+'core/content/editor/OfficeUpload.jsp?classId='+classId+'&editorId='+editorId+'&dialog=true&api=main_content'
		});
	...
	else
	{
		W.$.dialog({ 
		   ...
		   parent:api,
		    ...
		    content: 'url:'+basePath+'core/content/FormatOption.jsp?dialogMode=true',
				...
				if(okFlag)
				{
			        ...
			        //第' + currentPage + '页：' +currentTitle + 'oEditor.InsertHtml('<table class="jtopcms_system_page_flag" cellspacing="0" cellpadding="0" width="100%" style="height: 25px"><tr id='+Math.random()+' style="background-color: rgb(255,255,0)"><td class="jtopcms_system_page_flag_info" id="' + currentPage + '(((*)))' + currentTitle + '" align="center"><span style="font-size: 14px;color: #ff0000"><strong>第' + currentPage + '页：' +currentTitle + '</strong></span></td></tr></table>');
			     	...
			     	//currentPage = 0;
			     	 ...
			     	 ue.execCommand('insertHtml', '<img class="___jtopcms_system_page_flag___"  id="' + currentPage + '(((*)))' + currentTitle +'" alt="[标题] ' +currentTitle + '" style="background: yellow; height:30px;width: 100%"><br/>')   
					currentTitle = '';
					okFlag = false;
				}
	    	} 
	...
	else
	{
		W.$.dialog({ 
		   title :'分页',
		    ...
		    content: 'url:'+basePath+'core/content/TextPage.jsp?editorId='+editorId+'&dialogMode=true',
