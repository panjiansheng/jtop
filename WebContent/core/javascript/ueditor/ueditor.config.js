...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
          ...
          'jtuploadimage',  'jtuploadfile', 'jtuploadmedia', 'jtoffice', 'jtcimg', 'jtbmap', 'jttextpage', '|', 'print', 'searchreplace' ,'preview' ,'source'
        ]]
        ...
        //'jtuploadfile','jtuploadmedia','jtoffice','jtbmap',
		...
		,whitList: {
			...
			embed:  ['type', 'class', 'pluginspage', 'src', 'width', 'height', 'align', 'style', 'wmode', 'play',
			        'loop', 'menu', 'allowscriptaccess', 'allowfullscreen', 'id'],
			iframe: ['frameborder','border','marginwidth','marginheight','width','height','style','src', 'id']
		}
    };
