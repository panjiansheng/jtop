...
///////////////////////////////////////////////////////////////////////////////
var webFXTreeConfig = {
	rootIcon        : basepath+"/core/javascript/tree/xtree2b/images/folder.png",
	openRootIcon    : basepath+"/core/javascript/tree/xtree2b/images/openfolder.png",
	folderIcon      : basepath+"/core/javascript/tree/xtree2b/images/folder.png",
	openFolderIcon  : basepath+"/core/javascript/tree/xtree2b/images/openfolder.png",
	//默认文件改为Load状态，其他情况由代码业务决定图标号
	fileIcon        : basepath+"/core/javascript/tree/xtree2b/images/loading.gif",
	iIcon           : basepath+"/core/javascript/tree/xtree2b/images/I.png",
	lIcon           : basepath+"/core/javascript/tree/xtree2b/images/L.png",
	lMinusIcon      : basepath+"/core/javascript/tree/xtree2b/images/Lminus.png",
	lPlusIcon       : basepath+"/core/javascript/tree/xtree2b/images/Lplus.png",
	tIcon           : basepath+"/core/javascript/tree/xtree2b/images/T.png",
	tMinusIcon      : basepath+"/core/javascript/tree/xtree2b/images/Tminus.png",
	tPlusIcon       : basepath+"/core/javascript/tree/xtree2b/images/Tplus.png",
	plusIcon        : basepath+"/core/javascript/tree/xtree2b/images/plus.png",
	minusIcon       : basepath+"/core/javascript/tree/xtree2b/images/minus.png",
	blankIcon       : basepath+"/core/javascript/tree/xtree2b/images/blank.png",
...
_p.toHtml = function () {
	...
	var childrenHtml = "<div class=\"webfx-tree-children" +
		...
		sb.join("") +
		"</div>";
    var x = "<div class=\"webfx-tree-item\" id=\"" +
...
_p.getLabelHtml = function () {
	...
	if(this.boxNeed)
	{
		if(this.boxCheck)
		{
			checkboxMap.put(this.id,this.boxVal);
			if(this.boxNotUse)
			{
				checkboxHtml = "<input type='checkbox' style='vertical-align: middle;' disabled checked id=\'"+this.id+"\' name=\'"+this.id+"\' value=\'"+this.boxVal+"\'/>";
			}
			else
			{
				checkboxHtml = "<input type='checkbox' style='vertical-align: middle;' checked id="+this.id+" name="+this.id+" value=\'"+this.boxVal+"\'/>";
			}
		}
		else
		{	
			if(this.boxNotUse)
			{
				checkboxHtml = "<input type='checkbox' style='vertical-align: middle;' disabled id="+this.id+" name="+this.id+" value=\'"+this.boxVal+"\'/>";
			}
			else
			{
				checkboxHtml = "<input type='checkbox' style='vertical-align: middle;' id="+this.id+" name="+this.id+" value=\'"+this.boxVal+"\'/>";
			}
		}
	}
	
	//修改:去掉a点击后的边框线
	return checkboxHtml+"<a onclick=\"javascript:this.blur();\" href=\"" + webFXTreeHandler.textToHtml(this._getHref()) +
		"\" class=\"webfx-tree-item-label-box\" tabindex=\"-1\"" +
...
_p._onmousedown = function (e) {
	//火狐浏览器和IE的行为不同，必须显示地在 mousedown click 等事件时使用select方法选择当前被选择Node
	this.select();
	
	var el = e.target || e.srcElement;
	
	//add:若是checkbox不需要触发事件
	if('checkbox' != el.type)
	{
		//如果是叶子节点，不需要加载
		if(this.hasChildren())
...
_p._onclick = function (e) {
	...
	if('checkbox' == el.type)
	{
		if(el.checked)
		{
			checkboxMap.put(el.id,el.value);
		}
		else
		{
			checkboxMap.remove(el.id,el.value);		
		}
...
//栏目数风格图标
webFXTreeConfig.folderIcon="images/folder-horizontal.png";
webFXTreeConfig.openFolderIcon="images/folder-horizontal-open.png";
