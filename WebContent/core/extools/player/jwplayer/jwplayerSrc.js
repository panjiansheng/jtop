...
ABSOLUTE:"ABSOLUTE",RELATIVE:"RELATIVE",CDN:"CDN"
...
case b.utils.stretching.NONE:c.width=l;

c.height=g;

break;

case b.utils.stretching.UNIFORM:if(d>e){
...
case b.utils.stretching.FILL:if(d>e){
...
NONE:"NONE",FILL:"FILL",UNIFORM:"UNIFORM",EXACTFIT:"EXACTFIT"
...
x:b.utils.parseDimension(c.style.left),y:b.utils.parseDimension(c.style.top),width:b.utils.parseDimension(c.style.width),height:b.utils.parseDimension(c.style.height)
...
html5:"video/mp4",flash:"video"

} ,mov:{

html5:"video/quicktime",flash:"video"
...
html5:"audio/aac",flash:"video"

} ,mp3:{

html5:"audio/mp3",flash:"sound"
...
src:"file",preload:"preload",autoplay:"autostart",loop:"repeat",controls:"controls"

} ,source:{

src:"file",type:"type",media:"media","data-jw-width":"width","data-jw-bitrate":"bitrate"
...
NEW:"NEW",LOADING:"LOADING",ERROR:"ERROR",COMPLETE:"COMPLETE"
...
width:a.utils.strings.xmlAttribute(d.childNodes[c],"width"),bitrate:a.utils.strings.xmlAttribute(d.childNodes[c],"bitrate"),file:a.utils.strings.xmlAttribute(d.childNodes[c],"url")
...
FLASH:"FLASH",JAVASCRIPT:"JAVASCRIPT",HYBRID:"HYBRID"
...
width:400,height:300,components:{
...
players:"modes",autoplay:"autostart"
...
case"object":for(var m in k.plugins){
...
cursor:n,width:j,height:m,backgroundColor:"#000",position:"relative",textDecoration:"none",border:"none",display:"block"
...
cursor:n,position:"absolute",display:u?"block":"none",top:((m-50)/2),left:((j-50)/2),border:0,width:50,height:50,margin:0,padding:0,zIndex:2,backgroundImage:"url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAEpJREFUeNrszwENADAIA7DhX8ENoBMZ5KR10EryckCJiIiIiIiIiIiIiIiIiIiIiIh8GmkRERERERERERERERERERERERGRHSPAAPlXH1phYpYaAAAAAElFTkSuQmCC)"
...
width:j,height:m,display:o?"block":"none",position:"absolute",cursor:n,left:0,top:0,margin:0,padding:0,textDecoration:"none",zIndex:1,border:"none"
...
position:"relative",width:n,height:w
...
prefix:"http://l.longtailvideo.com/"+l+"/",file:"logo.png",link:"http://www.longtailvideo.com/players/jw-flv-player/",margin:8,out:0.5,over:1,timeout:5,hide:false,position:"bottom-left"
...
border:"none",textDecoration:"none",position:"absolute",cursor:"pointer",zIndex:10
...
position:"relative",height:x.height,width:x.width,padding:0,backgroundColor:E(),zIndex:0
...
width:x.width,height:x.height,top:0,left:0,zIndex:1,margin:"auto",display:"block"

} );

c(_videowrapper,{

overflow:"hidden",position:"absolute",top:0,left:0,bottom:0,right:0
...
case 27:if(u.jwGetFullscreen()){

u.jwSetFullscreen(false)

} break;

case 32:if(u.jwGetState()!=b.api.events.state.IDLE&&u.jwGetState()!=b.api.events.state.PAUSED){
...
top:0,bottom:0,left:0,right:0,width:H,height:E,position:"relative"
...
position:"absolute",width:(E-d.parseDimension(s.style.left)-d.parseDimension(s.style.right)),height:(F-d.parseDimension(s.style.top)-d.parseDimension(s.style.bottom)),zIndex:H
...
position:"fixed",width:x.width,height:x.height,zIndex:F
...
position:"absolute",margin:0,padding:0,top:null
...
case b.html5.view.positions.TOP:G.top=d.parseDimension(s.style.top);
...
position:"fixed",width:"100%",height:"100%",top:0,left:0,zIndex:2147483000
...
position:"relative",height:x.height,width:x.width,zIndex:0
...
backgroundcolor:"",margin:10,font:"Arial,sans-serif",fontsize:10,fontcolor:parseInt("000000",16),fontstyle:"normal",fontweight:"bold",buttoncolor:parseInt("ffffff",16),position:a.html5.view.positions.BOTTOM,idlehide:false,layout:{
...
height:J().height,backgroundColor:D.backgroundcolor
...
position:"absolute",height:J().height,left:(aj?aj.width:0),zIndex:0
...
id:k.id,duration:ad,position:j

} );

u({

id:k.id,bufferPercent:f
...
case a.api.events.state.PAUSED:case a.api.events.state.IDLE:if(!D.idlehide||_utils.exists(ai)){
...
component:"controlbar",boundingRect:O()
...
case"play":x("playButton",ao,false);
...
height:J().height,position:"absolute",top:0,width:ai
...
height:J().height,position:"absolute",display:"block",top:0
...
id:k.id,duration:ad,position:0

} );

u({

id:k.id,bufferProgress:0
...
id:k.id,duration:k.jwGetDuration(),position:0
...
id:k.id,mute:k.jwGetMute()

} );

r({

id:k.id,newstate:a.api.events.state.IDLE

} );

m({

id:k.id,volume:k.jwGetVolume()
...
case b.api.events.state.PLAYING:case b.api.events.state.BUFFERING:G.getMedia().pause();
...
case b.api.events.state.IDLE:if(e<0){
...
oldstate:N,newstate:b.api.events.state.IDLE
...
LIST:"LIST",ALWAYS:"ALWAYS",SINGLE:"SINGLE",NONE:"NONE"
...
case b.html5.controller.repeatoptions.SINGLE:u();

break;

case b.html5.controller.repeatoptions.ALWAYS:if(G.item==G.playlist.length-1&&!G.config.shuffle){
...
case b.html5.controller.repeatoptions.LIST:if(G.item==G.playlist.length-1&&!G.config.shuffle){
...
cursor:"pointer",top:0,left:0,overflow:"hidden"
...
cursor:"pointer",position:"absolute",top:((h.skin.getSkinElement("display","background").height-h.skin.getSkinElement("display","playIcon").height)/2),left:((h.skin.getSkinElement("display","background").width-h.skin.getSkinElement("display","playIcon").width)/2),border:0,margin:0,padding:0,zIndex:3,display:"none"
...
cursor:"pointer",position:"absolute",top:((u-h.skin.getSkinElement("display","background").height)/2),left:((e-h.skin.getSkinElement("display","background").width)/2),border:0,backgroundImage:(["url(",h.skin.getSkinElement("display","background").src,")"]).join(""),width:h.skin.getSkinElement("display","background").width,height:h.skin.getSkinElement("display","background").height,margin:0,padding:0,zIndex:2,display:"none"
...
display:"none",width:e,height:u,position:"absolute",cursor:"pointer",left:0,top:0,margin:0,padding:0,textDecoration:"none",zIndex:1
...
zIndex:4,position:"relative",opacity:0.8,backgroundColor:parseInt("000000",16),color:parseInt("ffffff",16),textAlign:"center",fontFamily:"Arial,sans-serif",padding:"0 5px",fontSize:14
...
width:(S-10),top:((R-P.display_text.getBoundingClientRect().height)/2)

} );

_css(P.display_iconBackground,{

top:((R-h.skin.getSkinElement("display","background").height)/2),left:((S-h.skin.getSkinElement("display","background").width)/2)
...
width:h.skin.getSkinElement("display",R).width,height:h.skin.getSkinElement("display",R).height,top:(h.skin.getSkinElement("display","background").height-h.skin.getSkinElement("display",R).height)/2,left:(h.skin.getSkinElement("display","background").width-h.skin.getSkinElement("display",R).width)/2
...
case a.api.events.state.BUFFERING:if(_utils.isIOS()){
...
case a.api.events.state.PAUSED:if(!_utils.isIOS()){
...
case a.api.events.state.IDLE:if(h.jwGetPlaylist()[h.jwGetItem()]&&h.jwGetPlaylist()[h.jwGetItem()].image){
...
default:if(h.jwGetPlaylist()[h.jwGetItem()]&&h.jwGetPlaylist()[h.jwGetItem()].provider=="sound"){
...
component:"display",boundingRect:_utils.getDimensions(P.display_iconBackground)
...
x:a.utils.parseDimension(A.style.left),y:a.utils.parseDimension(A.style.top),width:E,height:G
...
x:H.x,y:H.y,width:B.x-H.x+B.width,height:H.y-B.y+B.height
...
case a.api.events.state.IDLE:o();
...
prefix:"http://l.longtailvideo.com/html5/",file:"logo.png",link:"http://www.longtailvideo.com/players/jw-flv-player/",margin:8,out:0.5,over:1,timeout:5,hide:true,position:"bottom-left"
...
textDecoration:"none",position:"absolute",cursor:"pointer"
...
ended:a.api.events.state.IDLE,playing:a.api.events.state.PLAYING,pause:a.api.events.state.PAUSED,buffering:a.api.events.state.BUFFERING
...
fullscreen:y.fullscreen,width:J,hieght:I
...
position:y.position,duration:y.duration
...
height:I.target.videoHeight,width:I.target.videoWidth,duration:Math.round(I.target.duration*10)/10
...
case I.MEDIA_ERR_ABORTED:J="You aborted the video playback: ";
...
fullscreen:l.fullscreen,width:q,height:p
...
movie:s,allowfullscreen:"true",allowscriptaccess:"always"
...
src:s,type:"application/x-shockwave-flash",allowfullscreen:"true",allowscriptaccess:"always",width:n.width,height:n.height
...
id:_container.id,playlist:[],state:jwplayer.api.events.state.IDLE,position:0,buffer:0,config:{

width:480,height:320,item:-1,skin:undefined,file:undefined,image:undefined,start:0,duration:0,bufferlength:5,volume:90,mute:false,fullscreen:false,repeat:"",stretching:jwplayer.utils.stretching.UNIFORM,autostart:false,debug:undefined,screencolor:undefined
...
size:180,position:a.html5.view.positions.NONE,itemheight:60,thumbs:true,fontcolor:"#000000",overcolor:"",activecolor:"",backgroundcolor:"#f8f8f8",font:"_sans",fontsize:"",fontstyle:"",fontweight:""

} ;

var b={

_sans:"Arial, Helvetica, sans-serif",_serif:"Times, Times New Roman, serif",_typewriter:"Courier New, Courier, monospace"
...
background:undefined,item:undefined,itemOver:undefined,itemImage:undefined,itemActive:undefined
...
display:"block",width:l,height:C
...
case a.html5.view.positions.RIGHT:case a.html5.view.positions.LEFT:x.style.width=e.size+"px";
...
color:e.overcolor!==""?e.overcolor:F,backgroundImage:h.itemOver?"url("+h.itemOver.src+")":G
...
height:e.itemheight,display:"block",cursor:"pointer",backgroundImage:h.item?"url("+h.item.src+")":"",backgroundSize:"100% "+e.itemheight+"px"
...
height:M,width:L,"float":"left",styleFloat:"left",cssFloat:"left",margin:"0 5px 0 0",background:"black",overflow:"hidden",margin:K+"px",position:"relative"
...
fontSize:(e.fontsize?e.fontsize:11)+"px",fontWeight:(e.fontweight?e.fontweight:"bold"),width:"40px",height:e.fontsize?e.fontsize+10:20,lineHeight:24,"float":"right",styleFloat:"right",cssFloat:"right"
...
padding:"5px 5px 0 "+(K?0:"5px"),height:e.fontsize?e.fontsize+10:20,lineHeight:e.fontsize?e.fontsize+10:20,overflow:"hidden","float":"left",styleFloat:"left",cssFloat:"left",width:((P.duration>0)?E-50:E)-10+"px",fontSize:(e.fontsize?e.fontsize:13)+"px",fontWeight:(e.fontweight?e.fontweight:"bold")
...
display:"block","float":"left",styleFloat:"left",cssFloat:"left",margin:0,paddingLeft:N.style.paddingLeft,paddingRight:N.style.paddingRight,lineHeight:(e.fontsize?e.fontsize+4:16)+"px",overflow:"hidden",position:"relative"
...
case a.api.events.state.IDLE:_show(x);
...
author:"",date:"",description:"",image:"",link:"",mediaid:"",tags:"",title:"",provider:"",file:"",streamer:"",duration:-1,start:0,currentLevel:-1,levels:[]
...
file:"",streamer:"",bitrate:0,width:0
...
height:0,width:0,src:"",ready:false,image:w
