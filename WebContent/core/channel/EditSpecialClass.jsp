					...
					<form id="classForm" name="classForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<select class="form-select" id="parent" name="parent" disabled style="width:237px">
										<option value="-9999">
											----------- 默认顶级分类 -----------
										</option>
										<cms:CurrentSite>
							...
							<cms:SysClass id="${param.classId}">
								<tr>
									...
									<td class="td-input">
										<input type="text" style="width:237px" id="className" name="className" class="form-input" value="${Class.className}" />
								...
								<tr>
									...
									<td class="td-input">
										<input disabled  type="text" style="width:237px" id="classFlagShow"  class="form-input" value="${Class.classFlag}"></input>
