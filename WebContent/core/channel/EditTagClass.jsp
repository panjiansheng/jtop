		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					...
					<cms:QueryData service="cn.com.mjsoft.cms.channel.service.ChannelService" method="getSingleTagTypeQueryTag" objName="TagType" var="${param.tagTypeId}" >
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:231px" id="tagTypeName" name="tagTypeName" class="form-input" value="${TagType.tagTypeName}"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input disabled type="text" style="width:231px" id="flag" name="flag" class="form-input" value="${TagType.flag}"></input>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
						...
						<!-- hidden -->
						<input type="hidden" id="tagTypeId" name="tagTypeId" value="${param.tagTypeId}" />
					</form>
...
function submitTagClassForm()
{
	...
	var url = "<cms:BasePath/>channel/editTagClass.do"+"?<cms:Token mode='param'/>";
