					...
					<form id="irForm" name="irForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:280px" id="typeName" name="typeName" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:280px" id="typeFlag" name="typeFlag" class="form-input"></input>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
...
function submitIrForm()
{
	...
	irFrom.action = "<cms:BasePath/>channel/addCt.do";;
