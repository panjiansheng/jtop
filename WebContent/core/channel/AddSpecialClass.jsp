		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					...
					<div class="addtit">
						<img src="../style/icons/folder-open-table.png" width="16" height="16" />配置
					</div>
					...
					<form id="classForm" name="classForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<select class="form-select" id="parent" name="parent" style="width:237px">
										<option value="-9999">
											----------- 默认顶级分类 -----------
										</option>
										<cms:CurrentSite>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:237px" id="className" name="className" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:237px" id="classFlag" name="classFlag" class="form-input"></input>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
...
function submitContentClassForm()
{
	...
	var url = "<cms:BasePath/>channel/addSpecClass.do"+"?<cms:Token mode='param'/>";
