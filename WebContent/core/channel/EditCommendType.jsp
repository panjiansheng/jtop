						...
						<form id="typeForm" name="typeForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table" >
								<tr>
									...
									<td class="td-input">
										<select class="form-select" id="classId" name="classId" style="width:262px">
											<option value="-1">
												-----------&nbsp;请选择推荐位类型&nbsp;-----------
											</option>
											<option value="-9999">
								...
								<tr>
									...
									<td class="td-input">
										<input id="commendName" name="commendName" type="text" class="form-input" style="width:262px" value="${CommendType.commendName}" />
								...
								<tr>
									...
									<td class="td-input">
										<input id="commFlagShow" disabled type="text" class="form-input" style="width:262px" value="${CommendType.commFlag}" />
								...
								<tr>
									...
									<td class="td-input">
										<textarea id="typeDesc" name="typeDesc" class="form-textarea" style="width:260px; height:50px;">${CommendType.typeDesc}</textarea>
								</tr>
							...
							<script>
							initSelect('classId','${CommendType.classId}');
							initSelect('modelId','${CommendType.modelId}');
							initRadio('childClassMode','${CommendType.childClassMode}');
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a href="javascript:submitTypeForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitTypeForm()
{
   ...
   typeForm.action="<cms:BasePath/>channel/editCommendType.do";
   typeForm.submit();
}
