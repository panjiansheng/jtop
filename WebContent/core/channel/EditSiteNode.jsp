					...
					<form id="siteForm" name="siteForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input id="siteName" name="siteName" type="text" class="form-input" style="width:321px" value="${Site.siteName}"/>
							...
							<tr>
								...
								<td class="td-input">
									<input id="siteFlag" name="siteFlag" type="text" class="form-input" style="width:321px" value="${Site.siteFlag}" disabled/>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<input id="siteUrl" name="siteUrl" type="text" class="form-input" style="width:321px" value="${Site.siteUrl}"/>
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="home301Url" name="home301Url" class="form-textarea" style="width:322px; height:70px;">${Site.home301Url}</textarea>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="siteDesc" name="siteDesc" class="form-textarea" style="width:322px; height:50px;">${Site.siteDesc}</textarea>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<input type="radio" name="templateCharset" value="UTF-8"/>
									UTF-8&nbsp;
						...
						<input type="hidden" id='siteUrlOld'  value='${Site.siteUrl}' />
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" >
						<tr class="btnbg100">
							<div style="float:right">
								<a href="javascript:submitSiteForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
initRadio('templateCharset','${Site.templateCharset}');
...
function submitSiteForm()
{
   ...
   siteForm.action="<cms:BasePath/>site/editSiteBaseInfo.do";
   siteForm.submit();
}
