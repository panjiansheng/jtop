				...
				<table width="99.9%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="left">
							...
							当前位置：
							<a href="#">系统管理</a> &raquo; 广告内容扩展模型管理
						</td>
						<td align="right">
						...
						<table class="listtable" width="99.8%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									...
									<div>
										<a href="javascript:openCreateModelDialog();" class="btnwithico" onclick=""><img src="../style/icons/megaphone.png" width="16" height="16" /><b>新建广告内容模型&nbsp;</b> </a>

										<a href="javascript:deleteSelectSystemDataModel();" class="btnwithico" onclick=""><img src="../../core/style/default/images/del.gif" width="16" height="16" /><b>删除所选&nbsp;</b>
										</a>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:SystemDataModelList mode="manage" modelType="6" showMode="${param.showMode}">
												<cms:SystemDataModel>
...
function openCreateModelDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/metadata/CreateDataModelNoBe.jsp?modelType=6&uid='+Math.random()
...
function openEditModelDialog(modelId, siteId)
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/metadata/EditDataModelNoBe.jsp?modelType=6&modelId='+modelId+'&uid='+Math.random()
...
{  
	...
	window.location.href="ManageModelMetadata.jsp?modelId="+modelId+'&modelName='+encodeURIComponent(encodeURIComponent(modelName))+'&modelType=6';
}
...
function deleteSelectSystemDataModel()
{
	...
	$.dialog({ 
                    ...
                    content: '警告!模型以及其相关数据将被彻底删除,您确认执行吗？<br/>(注:只有主管能删除非本站模型,否则忽略)',
