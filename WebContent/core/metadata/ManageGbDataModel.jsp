						...
						<table class="listtable" width="99.8%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									...
									<div>
										<a href="javascript:openCreateModelDialog();" class="btnwithico" onclick=""><img src="../style/icons/balloons-box.png" width="16" height="16" /><b>新建留言扩展模型&nbsp;</b> </a>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:SystemDataModelList mode="manage" modelType="4" showMode="${param.showMode}">
												<cms:SystemDataModel >
...
function openCreateModelDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/metadata/CreateDataModelNoBe.jsp?modelType=4&uid='+Math.random()
...
function openEditModelDialog(modelId, siteId)
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/metadata/EditDataModelNoBe.jsp?modelType=4&modelId='+modelId+'&uid='+Math.random()
...
{  
	...
	window.location.href="ManageModelMetadata.jsp?modelId="+modelId+'&modelName='+encodeURIComponent(encodeURIComponent(modelName))+'&modelType=4';
}
