						...
						<form id="modelForm" name="modelForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								...
								<tr>
									...
									<td class="td-input">
										<input id="validateBehavior" name="validateBehavior" type="text" class="form-input" style="width:400px" value="${DataModel.validateBehavior}" />
										<br />
								...
								<tr>
									...
									<td class="td-input">
										<input id="beforeBehavior" name="beforeBehavior" type="text" class="form-input" style="width:400px" value="${DataModel.beforeBehavior}" />
										<br />
								...
								<tr>
									...
									<td class="td-input">
										<input id="afterBehavior" name="afterBehavior" type="text" class="form-input" style="width:400px" value="${DataModel.afterBehavior}" />
										<br />
								...
								<tr>
									...
									<td class="td-input">
										<input type="radio" name="titleMode" value="0"  onchange="javascript:changeTC(this)"/>
										是
										<input type="radio" name="titleMode" value="1" onchange="javascript:changeTC(this)"/>
										否
								...
								<tr id="tcTr" >
									...
									<td class="td-input">
										<input id="titleCol" name="titleCol" type="text" class="form-input" style="width:400px" value="${DataModel.titleCol}" />
										<br />
...
initRadio('titleMode','${DataModel.titleMode}');
initRadio('kwMode','${DataModel.kwMode}');
