						...
						<table class="listtable" width="99.8%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									<div class="fl">
  										筛选:
										<select class="form-select" id="showMode" onchange="javascript:changeFilter(this);">
											<option value="-1">
												--- 全部可见模型 ---
											</option>
											<option value="1">
									...
									<div>
										<a href="javascript:openCreateModelDialog();" class="btnwithico" onclick=""><img src="../style/icons/ruler--plus.png" width="16" height="16" /><b>新建数据模型&nbsp;</b></a>
...
function openCreateModelDialog()
{
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/metadata/CreateDataModel.jsp?modelType=2&uid='+Math.random()
...
function openEditModelDialog(modelId, siteId)
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/metadata/EditDataModel.jsp?modelType=2&modelId='+modelId+'&uid='+Math.random()
...
{  
	...
	window.location.href="ManageModelMetadata.jsp?modelId="+modelId+'&modelName='+encodeURIComponent(encodeURIComponent(modelName))+'&modelType=2';
}
