					...
					<form id="modelForm" name="modelForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<input id="modelName" name="modelName" type="text" class="form-input" style="width:155px" />
									<span class="red">*</span><span class="ps"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span class="input-title"><strong>标识: </span>
									<input id="modelSign" name="modelSign" type="text" class="form-input"  style="width:155px" />
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="remark" name="remark" class="form-textarea" style="width:390px; height:70px;"></textarea>
							</tr>
							...
							<tr>
								...
								<td class="td-input">
									<input id="validateBehavior" name="validateBehavior" type="text" class="form-input" style="width:390px" />
									<br/>
							...
							<tr>
								...
								<td class="td-input">
									<input id="beforeBehavior" name="beforeBehavior" type="text" class="form-input" style="width:390px" />
									<br/>
							...
							<tr>
								...
								<td class="td-input">
									<input id="afterBehavior" name="afterBehavior" type="text" class="form-input" style="width:390px" />
									<br/>
							...
							<tr>
								...
								<td class="td-input">
									<input type="radio" name="mustToken" value="1" checked />
									是
									...
									是
									<input type="radio" name="isManageEdit" value="0" checked />
									否
							...
							<tr>
								...
								<td class="td-input">
									...
									是
									<input type="radio" name="isMemberEdit" value="0" checked />
									否
