					...
					<form id="csForm" name="gatewayForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td  class="td-input">
									<input id="serverName" name="serverName" type="text" class="form-input" size="50" />
							...
							<tr>
								...
								<td  class="td-input">
									<input id="clusterUrl" name="clusterUrl" type="text" class="form-input" size="50" />
									<span class="red">*</span><span class="ps"></span>
								</td>
							</tr>
...
function submitAddCserver()
{
	...
	form.action = '../../cluster/addCluServer.do';
	form.submit();
}
