		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					...
					<cms:SystemPublishRule id="${param.ruleId}">
					<form id="ruleForm" name="ruleForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<input type="radio" disabled name="typev" value="1"  onclick="javascript:changeType(this);"/>
									栏目和专题首页
									<input type="radio" disabled name="typev" value="2" onclick="javascript:changeType(this);"/>
									栏目列表页
									<input type="radio" disabled name="typev" value="3" onclick="javascript:changeType(this);"/>
									专题列表页
									<input type="radio" disabled name="typev" value="4" onclick="javascript:changeType(this);"/>
									内容页
							...
							<tr>
								...
								<td class="td-input">
									<input id="savePathRule" name="savePathRule" type="text" class="form-input" style="width:375px" value="${Rule.savePathRule}"/>
							...
							<tr>
								...
								<td class="td-input">
									<input id="fileNameRule" name="fileNameRule" type="text" class="form-input" style="width:375px" value="${Rule.fileNameRule}"/>
							...
							<tr>
								...
								<td class="td-input">
									<input type="radio" name="suffixRule" value="1" />
									.html (默认发布名称)&nbsp;
						...
						<input type="hidden" id="ruleId" name="ruleId" value="${Rule.ruleId}" />
						<input type="hidden" id="type" name="type" value="${Rule.type}" />	
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a href="javascript:submitRuleForm();" class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确定&nbsp;</b> </a>
...
initRadio('typev', '${Rule.type}');

change('${Rule.type}');

if('.html' == '${Rule.suffixRule}')
{
	initRadio('suffixRule', '1');
}
else if('.shtml' == '${Rule.suffixRule}')
{
	initRadio('suffixRule', '2');
}
...
{	
	...
	ruleForm.action = '<cms:BasePath/>publish/editPubRule.do';
