...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var api = frameElement.api, W = api.opener;
         ...
         {
           	W.$.dialog.tips('编辑发布点成功',1,'32X32/succ.png'); 	 	
         }
					...
					<form id="gatewayForm" name="gatewayForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td  class="td-input">
									<input id="name" name="name" type="text" class="form-input"  style="width:340px" value="${Gateway.name}"/>
							...
							<tr>
								...
								<td class="td-input">
									<input type="radio" name="transfeType" value="1"  class="form-radio"  />
									html
							...
							<tr>
								...
								<td class="td-input">
									<input name="targetServerRoot" id="targetServerRoot" type="text" class="form-input" size="50" value="${Gateway.targetServerRoot}"/>
...
--%>
							<%--<tr id="trSeg">
								<td class="input-title">
									<strong>同步文件频率</strong>
								</td>
								<td class="td-input">
									每隔
									<input type="text" id="transferPeriod" name="transferPeriod" size=3 value="1" class="form-input" />
									<select id="transferPeriodType" name="transferPeriodType" class="form-select">
										<option value="1">
											秒 &nbsp;&nbsp;&nbsp;
										</option>
							...
							<tr>
								...
								<td class="td-input">
									<input type="radio" name="useState" value="1"  />
									启用
						...
						<!-- hidden -->
						<input type="hidden" id="gatewayId" name="gatewayId" value="${Gateway.gatewayId}" />
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a href="javascript:submitPublishGateway();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
initSelect('targetServerId','${Gateway.targetServerId}');
initSelect('targetCloudId','${Gateway.targetCloudId}');
initRadio('transfeType','${Gateway.transfeType}');
initRadio('useState','${Gateway.useState}');

var api = frameElement.api, W = api.opener;

function submitPublishGateway(id)
{
	...
	form.action = '<cms:BasePath/>site/editPublishGateway.do';
