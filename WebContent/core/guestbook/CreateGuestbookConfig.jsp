					...
					<form id="cofigForm" name="cofigForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<input id="cfgName" name="cfgName" type="text" class="form-input" style="width:292px"  />
							...
							<tr>
								...
								<td class="td-input">
									<input id="cfgFlag" name="cfgFlag" type=" text" class="form-input" style="width:292px" />
									<span class="red">*</span><span class="ps"></span>
								</td>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="cfgDesc" name="cfgDesc" style="width:290px;height:50px" class="form-textarea"></textarea>
								</td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a name="btnwithicosysflag" href="javascript:submitGbCofigForm();" class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确定&nbsp;</b> </a>
...
function submitGbCofigForm()
{
	...
	cofigForm.action = '<cms:BasePath/>guestbook/createGbConfig.do';
