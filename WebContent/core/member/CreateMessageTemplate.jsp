...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>  
	         ...
	         $(function()
			 {
			    validate('templateName',0,ref_name,'格式为文字,数字,下划线');
	 			validate('mtFlag',0,ref_flag,'格式为字母,数字,下划线');	
					...
					<form id="mgtForm" name="mgtForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:184px" id="templateName" name="templateName" class="form-input"></input>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span class="input-title"><strong>标识</strong>
									</span>
									<input type="text" style="width:184px" id="mtFlag" name="mtFlag" class="form-input"></input>
								</td>
							</tr>
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:438px" id="templateTitle" name="templateTitle" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="templateContent" name="templateContent" style="height:280px;width:442px"  ></textarea>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a name="btnwithicosysflag" href="javascript:submitMsgTemplate();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitMsgTemplate()
{
	var hasError = false;
	//系统信息字段验证
    var currError = submitValidate('mtFlag',0,ref_flag,'格式为字母,数字,下划线');	
    ...
    currError = submitValidate('templateName',0,ref_name,'格式为文字,数字,下划线');
	...
	form.action = '<cms:BasePath/>member/createMT.do';
	form.submit();
}
