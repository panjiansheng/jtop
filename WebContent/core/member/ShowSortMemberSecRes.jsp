				...
				<td align="left" valign="top">
					...
					<table class="listdate" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr class="datahead">
							...
							<cms:MemberResourceList protectType="100" roleId="all" linear="${param.parentResLinear}" parentLinearMode="true">
...
function upAction(index,currentId)
{
	...
	document.sortForm.action="<cms:BasePath/>security/sortMemberSecRes.do";
