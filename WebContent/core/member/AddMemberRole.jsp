					...
					<form id="roleForm" name="roleForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:242px" id="roleName" name="roleName" class="form-input" ></input>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="roleDesc" name="roleDesc" style="width:242px; height:70px;" class="form-textarea"></textarea>
								</td>
							</tr>
...
function submitRoleForm()
{
   ...
   roleForm.action="<cms:BasePath/>security/addMemberRole.do";
