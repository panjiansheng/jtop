						...
						<tr>
							<td style="padding: 7px 10px;">
								<div class="fl">
									...
									<a href="javascript:clearAcc();" class="btnwithico"><img src="../style/icons/folder--minus.png" width="16" height="16" /><b>解除全站浏览权限&nbsp;</b> </a>
								</div>
														...
														<td>
															<center>
																<select id="classAcc-${Class.classId}" name="classAcc-${Class.classId}" class="form-select">
																	...
																	<cms:QueryData service="cn.com.mjsoft.cms.security.service.SecurityService" method="getMemberAccRuleListForTag" var="1" objName="MemAcc">
...
<cms:QueryData service="cn.com.mjsoft.cms.security.service.SecurityService" var="1" method="getMemberAccForTag" objName="Acc">
...
function applyAcc()
{
	var url = "<cms:BasePath/>security/applyAcc.do?typeId=1"+"&<cms:Token mode='param'/>";
...
{
	var url = "<cms:BasePath/>security/applyChildAcc.do?typeId=1&classId="+cid+"&<cms:Token mode='param'/>";
...
function clearAcc()
{
	...
	var dialog = $.dialog({ 
                    ...
                    content: '将解除所有栏目会员浏览限制,您确定要执行吗?',
                    
                    ok: function () { 
       
   						var url = "<cms:BasePath/>security/clearAcc.do?typeId=1"+"&<cms:Token mode='param'/>";
