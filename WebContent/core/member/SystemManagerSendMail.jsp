						...
						<form id="mgtForm" name="mgtForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								...
								<tr>
									...
									<td class="td-input">
										<select class="form-select" onchange="javascript:selectParamForUE(this,'templateContent')" style="width:165px">
											<option value="">
												------- 备选参数 -------
											</option>
...
function submitMsg()
{
	...
	form.action = '<cms:BasePath/>member/sendMail.do?ids='+ids;
