							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									...
									筛选：<select id="mainRes" name="mainRes" onchange="javascript:filter(this)">
												...
												<cms:MemberResourceList mainMode="true" roleId="all">
												<cms:MemberResource>
									...
									<div>
										<a href="javascript:openAddResourceDialog();" class="btnwithico" onclick=""><img src="../style/icons/puzzle--plus.png" width="16" height="16" /><b>增加会员资源&nbsp;</b> </a>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:MemberResourceList protectType="100" roleId="all" linear="${param.linear}">
												<cms:MemberResource>
													<tr>
...
function openAddResourceDialog()
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/member/AddMemberSecurityResource.jsp?linear=${param.linear}'
	});
}
...
function openEditResourceDialog(resId)
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:Domain/>core/member/EditMemberSecurityResource.jsp?id='+resId
	});
}
...
{    
    ...
    window.location.href = '<cms:Domain/>security/deleteMemberSecurityResource.do?id='+resId+"&<cms:Token mode='param'/>";
    }, 
    cancel: true 
    });
}
...
function filter(obj)
{
	 window.location = 'ManageMemberResource.jsp?linear='+obj.value;
}
...
function showSortSecResPage()
{
	...
	$.dialog({ 
        ...
        content: 'url:<cms:BasePath/>core/member/ShowSortMemberSecRes.jsp?parentResLinear='+resLinear
	});
}
