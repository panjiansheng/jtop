						...
						<table class="listtable" width="99.8%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td style="padding: 7px 10px;" class="">
									<div class="fl">									
										会员名称:
										<input class="form-input" type="text" size="30" id="userName" name="userName" value="${param.userName}"/>
								...
								<td id="uid_td25" style="padding: 2px 6px;">
									<div class="DataGrid">
										<table id="showlist" class="listdate" width="100%" cellpadding="0" cellspacing="0">
											...
											<cms:QueryData objName="MLI" service="cn.com.mjsoft.cms.member.service.MemberService" method="getMemberLoginTraceTag" var="${param.userName},${param.pn},10">
												<tr>
