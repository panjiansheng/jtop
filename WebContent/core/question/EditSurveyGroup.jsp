...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<cms:SystemSurverGroup groupId="${param.id}">
						...
						<form id="surveyGroupForm" name="surveyGroupForm" method="post">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
								...
								<tr>
									...
									<td class="td-input">
										<input id="questName" name="questName" type="text" class="form-input" style="width:316px;" value="${Group.questName}" />
								...
								<tr>
									...
									<td class="td-input">
										<input readonly id="flagName" name="flagName" type="text" class="form-input" style="width:316px;" value="${Group.flagName}" />
										<span class="red">*</span><span class="ps"></span>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="td-input">
										<textarea id="questDesc" name="questDesc" class="form-textarea" style="width:316px; height:60px;">${Group.questDesc}</textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="td-input">
										<input value="${Group.startDate}" id="startDate" name="startDate" style="width:140px;" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'});" />
										&nbsp;&nbsp;至&nbsp;&nbsp;
										<cms:if test="${Group.endDate=='9999-12-31'}">
											<input value="" id="endDate" name="endDate" style="width:140px;" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'});" />
										</cms:if>
										<cms:else>
											<input value="${Group.endDate}" id="endDate" name="endDate" style="width:140px;" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'});" />
										</cms:else>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="td-input">
										...
										<span class="STYLE12">按照IP唯一性限制</span>&nbsp;
									</td>
								</tr>
								<tr>
									<td class="input-title">
									...
									<td class="td-input">
										<input id="restInterval" name="restInterval" type="text" class="form-input" style="width:100px;" value="${Group.restInterval}" />
								...
								<tr>
									...
									<td class="td-input">
										<input name="needCaptcha" type="radio" value="1" />
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr class="btnbg100">
									<div style="float:right">
										<a href="javascript:submitSurveyGroupForm();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
initSelect('classId','${Group.classId}');

initRadio('restriction','${Group.restriction}');

initRadio('needCaptcha','${Group.needCaptcha}');

initRadio('useState','${Group.useState}');
...
function submitSurveyGroupForm()
{
   if($('#classId').val() == '-1')
	...
	if('${Group.flagName}' != $('#flagName').val())
	{
   ...
   questInfoForm.action="<cms:BasePath/>survey/editSurveyGroup.do";
