					...
					<form id="saForm" name="saForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:420px" id="anTitle" name="anTitle" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<textarea id="content" name="content" style="height:240px;width:423px" ></textarea>
							...
							<tr>
								...
								<td class="td-input">
									...
									<input id="showStartDate" name="showStartDate" style="width:194px" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'});" />
									&nbsp;至 &nbsp;
									<input id="showEndDate" name="showEndDate" style="width:194px" maxlength="30" type="text" class="form-input-date" onmousedown="javascript:WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'});" />
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a name="btnwithicosysflag" href="javascript:submitSa();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitSa()
{
	...
	form.action = '<cms:BasePath/>interflow/addAn.do';
