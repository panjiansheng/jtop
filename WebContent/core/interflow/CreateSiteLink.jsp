					...
					<form id="flForm" name="flForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:258px" id="siteName" name="siteName" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:258px" id="siteLink" name="siteLink" class="form-input" value="http://"></input>
								</td>
							</tr>
											...
											<td>
												<table border="0" cellpadding="0" cellspacing="0" height="65px" class="form-table-big">
													<tr>
														<td>
															&nbsp;
															<input type="button" onclick="javascript:showModuleImageDialog('siteLogoCmsSysImgShow','siteLogo','','','1','0');" value="上传" onclick="" class="btn-1" />
													...
													<tr>
														<td>
															&nbsp;&nbsp;宽&nbsp;&nbsp;
															<input id="siteLogoCmsSysImgWidth" class="form-input" readonly type="text" style="width:44px" />
															&nbsp;&nbsp;&nbsp;&nbsp;高&nbsp;&nbsp;
															<input id="siteLogoCmsSysImgHeight" class="form-input" readonly type="text" style="width:44px" />


														</td>
													</tr>
												</table>
												<input id="siteLogo" name="siteLogo" type="hidden" />
											</td>
										</tr>
									</table>
								</td>
...
function submitFl()
{
	...
	form.action = '<cms:BasePath/>interflow/addFSite.do';
