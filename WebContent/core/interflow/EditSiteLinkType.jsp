		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top">
					...
					<cms:QueryData objName="Ft" service="cn.com.mjsoft.cms.interflow.service.InterflowService" method="getFriendSiteTypeTag" var="${param.ltId}">
					...
					<form id="flForm" name="flForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:258px" id="typeName" name="typeName" class="form-input" value="${Ft.typeName}"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" disabled style="width:258px" id="typeFlag" name="typeFlag" class="form-input" value="${Ft.typeFlag}"></input>
								</td>
							</tr>
						...
						<!-- hidden -->
						<input type="hidden" id="ltId" name="ltId" value="${param.ltId}"/>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr class="btnbg100">
								<div style="float:right">
									<a href="javascript:submitFl();"  class="btnwithico"><img src="../style/icons/tick.png" width="16" height="16" /><b>确认&nbsp;</b> </a>
...
function submitFl()
{
	...
	form.action = '<cms:BasePath/>interflow/editFSiteType.do';
