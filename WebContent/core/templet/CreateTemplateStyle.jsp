					...
					<form id="tsForm" name="tsForm" method="post">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:258px" id="styleName" name="styleName" class="form-input"></input>
							...
							<tr>
								...
								<td class="td-input">
									<input type="text" style="width:258px" id="styleFlag" name="styleFlag" class="form-input"></input>
								</td>
							</tr>
											...
											<td>
												<table border="0" cellpadding="0" cellspacing="0" height="65px" class="form-table-big">
													<tr>
														<td>
															&nbsp;
															<input type="button" onclick="javascript:showModuleImageDialog('stylePicCmsSysImgShow','stylePic','','','1','0');" value="上传" onclick="" class="btn-1" />
													...
													<tr>
														<td>
															&nbsp;&nbsp;宽&nbsp;&nbsp;
															<input id="stylePicCmsSysImgWidth" class="form-input" readonly type="text" style="width:44px" />
															&nbsp;&nbsp;&nbsp;&nbsp;高&nbsp;&nbsp;
															<input id="stylePicCmsSysImgHeight" class="form-input" readonly type="text" style="width:44px" />


														</td>
													</tr>
												</table>
												<input id="stylePic" name="stylePic" type="hidden" />
											</td>
										</tr>
									</table>
								</td>
...
function submitTs()
{
	...
	//后台验证
	var count = validateExistFlag('templateStyle', $('#styleFlag').val());
	
	if(count > 0)
	{
		showTips('styleFlag', '系统已存在此值,不可重复录入');
	...
	form.action = '<cms:BasePath/>templet/addTs.do';
