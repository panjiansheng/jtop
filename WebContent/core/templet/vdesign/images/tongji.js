...
{
	var unit_id     = "2073562";
	var client_ip   = "58.215.106.163";
	var server_time = "1302828945";
	var verify_code = "4776e325";
	var type        = "0";
...
var cm_url = {'445':{url:'http://design.taobao.com/', url_type:'0'},'446':{url:'http://design.taobao.com/shop/sup/super_theme.htm', url_type:'0'}};
		for(var i in cm_url) {
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2073562/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
