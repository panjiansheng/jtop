	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
			...
			<tr>
				...
				<td class="td-input">
					 <input id="st" name="st" type="text" style="width:80px" class="form-input" value="" />
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 <span class="input-title"><strong>结束秒数</strong></span>
					 <input id="et" name="et" type="text" style="width:80px" class="form-input" value="" />
...
function covert()
{
	...
	var url = "<cms:BasePath/>resources/covrertVideo.do"+"?<cms:Token mode='param'/>";
 	...
 	var postData = 'resId=${param.id}&act=cut&st='+$('#st').val()+'&et='+$('#et').val();
