...
function loadChildTree() {
	...
	if (tree.getSelected()) 
	{
		...
		{
			var folder = current.getId();
		  	$.getJSON
			(
				targetJSONsrc, 
	      		{
	      			parentFolder :  encodeURIComponent(folder),
	      			mode : 'folder' //强制目录模式
	      		},
	      		function(data)
	      		{
	      			...
	      			(
	      				...
	      				function(i,item)
	      				{
	      					...
	      					x.setAction(targetListContentSrc+"?parentFolder="+encodeURIComponent(encodeURIComponent(item.entry)));
