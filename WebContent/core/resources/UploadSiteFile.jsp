...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript" src="../javascript/upload/SWFUpload/handlerFile.js"></script>
		<script>
			...
			swfu = new SWFUpload({
			upload_url: "<cms:BasePath/>resources/multiUploadSiteFile.do;jsessionid=<cms:SID/>",
			
			// File Upload Settings
			file_size_limit : "5000 MB", // 5000MB 固定,后台资源管理使用
			file_types : "*.jsp;*.xml;*.shtml;*.htm;*.html;*.js;*.css;*.txt;*.pdf;*.swf;*.flv;*.png;*.jpeg;*.gif;*.bmp;*.jpg;*.f4v;*.avi;*.mpg;*.mpeg;*.mp3;*.wav;*.mp4;*.doc;*.docx;*.pptx;*.ppt;*.xlsx;*.xls;*.vsd;*.zip;*.rar;*.dat",//设置可上传的类型
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-table">
			<tr>
				...
				<td class="td-input">
					<textarea id="fileInfo" name="fileInfo" class="form-textarea" readonly style="width:370px; height:80px;"></textarea>
