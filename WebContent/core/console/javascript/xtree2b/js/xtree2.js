		        ...
		        {     
			      			...
			      			(
			      				...
			      				function(i,item)
			      				{
			      					...
			      					x.setAction("javascript:window.location='"+item.targetListPage+"?classId="+item.classId+"&modelId="+item.contentModelId+"';");
			      					x.target= 'main';
...
_p.getLabelHtml = function () {
	...
	//修改:去掉a点击后的边框线
	return "<a onclick=\"javascript:this.blur();\" href=\"" + webFXTreeHandler.textToHtml(this._getHref()) +
