...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="../javascript/tree/xtree2b/css/xtree2.links.css" type="text/css" rel="stylesheet" />
		...
		var targetJSONsrc = "<cms:BasePath/>channel/listContentClassInfoTree.do?mode=special";
...
scrollbar-track-color:#fcfcfc;/*- 滑道 -*/  
	...
	<body class="menutree">
		...
		<table width="100%" height="100%" align="left" border='0' cellspacing='0' cellpadding='0'>
			...
			var targetJSONsrc = '<cms:BasePath/>channel/listContentClassInfoTree.do?mode=special&layer=2';
			//var targetListContentSrc =item.targetListPage+'?classId=';
			
			var parentId = -9999;//暂时没有分站，永远为总站-9999
			var tree = new WebFXTree('${CurrSite.siteName}专题');
			      			...
			      			(
			      				...
			      				function(i,item)
			      				{
			      					...
			      					else if(item.layer == 2)//次级栏目
      								{
				      					...
				      					{				      						
				      						xl2.openIcon="../../core/style/icon/"+item.iconFile;
			      							xl2.icon="../../core/style/icon/"+item.iconFile;	      							
				      					}
