...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var targetJSONsrc = "<cms:BasePath/>channel/listContentClassInfoTree.do?trash=true";
...
scrollbar-track-color:#fcfcfc;/*- 滑道 -*/  
	...
	<body class="menutree">
		...
		<table width="100%" height="100%" align="left" border='0' cellspacing='0' cellpadding='0'>
			...
			var targetJSONsrc = '<cms:BasePath/>channel/listContentClassInfoTree.do?parent=-9999&layer=2&trash=true';
			//var targetListContentSrc =item.targetListPage+'?classId=';
			
			var parentId = -9999;//暂时没有分站，永远为总站-9999
			var tree = new WebFXTree('${CurrSite.siteName}回收站');
			
			tree.icon = "images/trash2.png";
			tree.openIcon="images/trash.png";
			tree.setId(-9999);
			tree.target= 'main';
