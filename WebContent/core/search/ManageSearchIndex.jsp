											...
											<cms:SystemClassList site="${CurrSite.siteFlag}" type="all">
												<cms:SysClass>
													<tr id="${Class.linearOrderFlag}" ondblclick="javascript:change(this);">
														<td>
															<cms:if test="${Class.searchStatus == 1}">
														...
														<td>
															<center>
																<a href="javascript:submitRebuildIndex('${Class.classId}', '${Class.className}');"><img src="../../core/style/icon/sort-quantity.png" width="16" height="16" />索引</a> &nbsp;
																<a href="javascript:deleteSearchIndex('${Class.classId}');"><img src="../style/icons/bin-full.png" width="16" height="16" />清除</a>&nbsp;&nbsp;&nbsp;
															</center>
														</td>
													</tr>
												</cms:SysClass>
...
function submitRebuildIndex(classId, className)
{
	...
	var url = "<cms:BasePath/>search/rebuildIndex.do?ids="+classId+"&key="+key+"&<cms:Token mode='param'/>";
...
function deleteSearchIndex(classInfo,siteMode)
{
	...
	var dialog = $.dialog({ 
                    ...
                    var url = "<cms:BasePath/>search/deleteSearchIndex.do?siteMode="+ siteMode+"&idInfo="+ids+"&<cms:Token mode='param'/>";
...
function showIndexRTStatus(key)
{
   ...
   $.ajax
   (
   {type:'POST',async:false,url:url,dataType:'json',success:
